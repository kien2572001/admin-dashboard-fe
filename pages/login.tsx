...
import AuthServices from "@/app/services/api/auth-api";
import { toast } from "react-toastify";
import { signIn } from "@/app/services/contexts/auth/reducers";
        ...
        <section className="content-main mt-80 mb-80">
          <div className="card mx-auto card-login">
            <div className="card-body">
              ...
              <p className="text-center small text-muted mb-15">
                or sign up with
              </p>
              <div className="d-grid gap-3 mb-4">
                <a href="#" className="btn w-100 btn-light font-sm">
                  <svg
                    aria-hidden="true"
                    className="icon-svg"
                    width="20"
